/*
Modified FONTS for 0.8 wifi clock
...
#ifndef myTM16XXFonts_h
#define myTM16XXFonts_h

// definition for standard hexadecimal numbers
const PROGMEM byte myTM16XX_NUMBER_FONT[] = {
  0b11111100, // 0
  0b10000100, // 1
  0b10111010, // 2
  0b10101110, // 3
...
const PROGMEM byte myTM16XX_FONT_DEFAULT[] = {
  0b00000000, // (32)  <space>
  0b10000110, // (33)	!
  0b00100010, // (34)	"
  0b01111110, // (35)	#
